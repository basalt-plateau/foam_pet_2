...
module builder_1::Voht_Steady_2 {
	...
	*/
    ...
    public fun ending__cannot_buy_more_than_the_limit (
		...
		if (Void_Freight_Group::Freighter_has_joined_the_sport (Freighter_03_position) != utf8 (b"yup")) { abort 1 };
		...
		Void_Freight_Group::Buy_5_Vohts_for_1_APT (& freighter_01_consenter);
		if (Void_Freight_Group::Tiny_Water_Balloons_Score (Freighter_01_position) != 10) { abort 1 };
		if (Void_Freight_Group::Tiny_Water_Balloons_For_Sale_Left () != 0) { abort 2 };
