...
module ride::Rondoval_Mtembezi_Health_1 {
	...
	use ride::Rondoval_Mtembezi::{ accept_mtembezi, Mtembezi };
    ...
    public fun novel_1 (
		...
		//
		let mtembezi_1_address : address = Rondoval_Mtembezi::ask_for_address (& mtembezi_1);
		assert! (mtembezi_1_address == estate_1_legacy_address, Problem);
		let mtembezi_1_thermoplastic_sheets_count = Rondoval_Mtembezi::ask_for_thermoplastic_sheets_count (& mtembezi_1);
		...
		let mtembezi_1_thermoplastic_sheets_count_1 : u64 = Rondoval_Mtembezi::ask_to_add_thermoplastic_sheets (
			&mut mtembezi_1, 
			add_sheets_1
		);
		debug::print (& mtembezi_1_thermoplastic_sheets_count_1);
		assert! (mtembezi_1_thermoplastic_sheets_count_1 == add_sheets_1, Problem);
		debug::print (& Rondoval_Mtembezi::ask_for_thermoplastic_sheets_count (& mtembezi_1));
		assert! (Rondoval_Mtembezi::ask_for_thermoplastic_sheets_count (& mtembezi_1) == add_sheets_1, Problem);
		...
		let mtembezi_2_thermoplastic_sheets_count_1 : u64 = Rondoval_Mtembezi::ask_to_add_thermoplastic_sheets (
			&mut mtembezi_2, 
			add_sheets_2
		);
		debug::print (& mtembezi_2_thermoplastic_sheets_count_1);
		assert! (mtembezi_2_thermoplastic_sheets_count_1 == add_sheets_2, Problem);
		debug::print (& Rondoval_Mtembezi::ask_for_thermoplastic_sheets_count (& mtembezi_2));
		assert! (Rondoval_Mtembezi::ask_for_thermoplastic_sheets_count (& mtembezi_2) == add_sheets_2, Problem);
		...
		let receipt_1 : String = Rondoval_Mtembezi::ask_to_send_thermoplastic_sheets (
			&mut mtembezi_1, 
			&mut mtembezi_2,
			to_send_1
		);
		...
		//
		let to_send_2 : u64 = 1;
		let receipt_2 : String = Rondoval_Mtembezi::ask_to_send_thermoplastic_sheets (
			&mut mtembezi_1, 
			&mut mtembezi_2,
			to_send_2
		);
		...
		//
		let to_send_3 : u64 = 1;
		let receipt_3 : String = Rondoval_Mtembezi::ask_to_send_thermoplastic_sheets (
			&mut mtembezi_2, 
			&mut mtembezi_1,
			to_send_3
		);
