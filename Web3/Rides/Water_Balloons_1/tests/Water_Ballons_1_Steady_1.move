...
module builder_1::Water_Ballons_1_Steady_1 {
	...
	public fun prepare (
		...
		coin::transfer<AptosCoin>(owner_1_consenter, player_02_position, 500);
		coin::transfer<AptosCoin>(owner_1_consenter, player_03_position, 500);	
	}
	...
	*/
    ...
    public fun steady_1 (
		...
		//
		//
		let water_balloons_for_sale : u256 = 900000;
		...
		//	Throw
		//
		Water_Balloons_1_Sport::Throw_Water_Balloon (& player_01_consenter, player_02_position);
		...
		//	End
		//
		Water_Balloons_1_Sport::End (& owner_1_consenter);	
		//
		////		
